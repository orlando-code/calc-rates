...
```{r}
# plot(out$cooks_dist, type = "o", pch = 19,
...
results <- meta_analysis_end_to_end(all_data, "phtot", "effect_size", "effect_var", mods_formula=temp_mods_formula, run_id="temp_naive")
